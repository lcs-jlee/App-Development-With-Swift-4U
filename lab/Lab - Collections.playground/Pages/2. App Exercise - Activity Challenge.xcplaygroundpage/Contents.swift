 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 10 miles a day"]
var runningChallenges: [String] = ["Run 3 miles a day", "Run 10 miles a day"]
...
} else if availableChallenges.count == 1{
