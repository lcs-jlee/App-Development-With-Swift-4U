 ...
 */
var dictionary = ["January": 31, "Fabuary": 28, "March": 31]
print(dictionary)
/*:
 ...
 */
if let JanuaryValue = dictionary["January"] {
 ...
 */
let shapesArray = ["Circle": "Red", "Square": "Green", "Triangle": "Blue"]
let colorsArray = ["Red": "Circle", "Green": "Square", "Blue": "Triangle"]
 ...
 */
if let lastValue = colorsArray["Blue"] {
    print(lastValue)
}
