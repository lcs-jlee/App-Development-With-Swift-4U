...
let congratulations = "Congratulations, \(firstName + lastName)! You beat your previous daily high core of \(previousBest) steps by walking \(newBest) steps yesterday!"
